...
result = data_tools_controller.html_clean(content, output_type)
...
result = data_tools_controller.html_extract(content, tag, attribute, base_url)
...
result = security_and_networking_controller.host_reputation(host)
...
result = security_and_networking_controller.url_info(url, fetch_content)
...
```python
latitude = 89.0931104026237
longitude = 89.0931104026237
language_code = 'en'
